...
Cities have taken notice. Long Beach, CA [has a fellowship program](https://www.longbeach.gov/) for recent grads to spend a year rotating through four different departments. The [Johns Hopkins University Applied Physics Lab ](https://www.jhuapl.edu/)requires 2 rotating internships for federal government employees. ICMA even has a three-month [talent exchange program](https://icma.org/job-center) between local governments.
