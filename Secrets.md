...
Feedback is a two-way street, and every fellowship program can benefit from some self-reflection. Self-reflection should occur at (at least) three different times during the life of the fellow. 
During the fellowship, managers should check in with the analysts on how their experience is going so it can be adjusted mid-flight. 
